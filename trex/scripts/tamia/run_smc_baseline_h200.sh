...
# =============================================================================
# SMC Steering Baseline - H200 Configuration (8 GPUs)
# =============================================================================
...
# H200: 8 GPUs - TP=4 per model for maximum throughput
GENERATOR_TP_SIZE=4
REWARD_MODEL_TP_SIZE=4
GPU_MEMORY_UTILIZATION=0.92
N_PARTICLES=32  # Double particles with more GPUs
...
echo "=============================================="
echo "SMC Steering Baseline (H200 - 8 GPUs)"
echo "=============================================="
