...
CKPT_BASE_DIR="trex/results/grpo_baseline/${MODEL_NAME}/${DATASET}_n${TRAIN_N_SAMPLES}/checkpoints"
...
# -----------------------------------------------------------------------------
TEST_DATASET="gsm8k"
TEST_DATASET_PATH="trex/data/gsm8k_platinum_test.jsonl" # Consistent with training script
